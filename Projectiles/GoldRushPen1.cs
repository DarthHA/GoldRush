...
{
    public class GoldRushPen1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.position.X += (Projectile.ai[0] / 4f * 20f - 5) * owner.direction;
            }
            else
            {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                if (glow.active && glow.type == ModContent.ProjectileType<GoldRushPenGlow1>() && glow.owner == Projectile.owner)
                {
                    (glow.ModProjectile as GoldRushPenGlow1).DrawAlt(Main.spriteBatch);
                }
            }
            return false;
        }
